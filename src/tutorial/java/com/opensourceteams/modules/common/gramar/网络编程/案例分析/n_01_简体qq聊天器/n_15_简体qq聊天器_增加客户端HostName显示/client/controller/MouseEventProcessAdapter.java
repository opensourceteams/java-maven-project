package com.opensourceteams.modules.common.gramar.网络编程.案例分析.n_01_简体qq聊天器.n_15_简体qq聊天器_增加客户端HostName显示.client.controller;
...
public class MouseEventProcessAdapter extends MouseAdapter {
    ...
    public void mouseClicked(MouseEvent e) {
        if(e.getComponent() == btnSend){
            ...
            new CommonMessageSenderThread(socket,text, Message.DATA_TRANSFORM_TYPE_CLIENT_SEND_GROUP_MESSAGE).start();
            taContent.setText("");
        }
    }
}
