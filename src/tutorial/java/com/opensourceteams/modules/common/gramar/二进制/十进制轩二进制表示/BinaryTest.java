...
public class BinaryTest {
    ...
    public  static void getMaxValueByByteLength2(){
        System.out.println( "byte 为固定位数1位,最大整数值:" + BinaryUtil.getMaxValueByByteLength(1));
        System.out.println( "byte 为固定位数2位,最大整数值:" +BinaryUtil.getMaxValueByByteLength(2));
        System.out.println( "byte 为固定位数3位,最大整数值:" +BinaryUtil.getMaxValueByByteLength(3));
        System.out.println( "byte 为固定位数4位,最大整数值:" +BinaryUtil.getMaxValueByByteLength(4));
    ...
    public  static void printByteToBits(){
        ...
        for (; i< 127;i++ ){
            ...
            System.out.println(  "byte类型的数:" + i+ " 转换为bit的表现形式:" + BinaryUtil.byteToBits(i)  +" 长度:" + BinaryUtil.byteToBits(i).length());
    ...
    public static int getMaxValueByByteLength(int byteLength){
        ...
        for(int i =0;i< byteLength * 8 -1;i++){
            sb.append("1");
            System.out.println(sb.toString() +" : " +BinaryUtil.convertIntByBit(sb.toString()) + " 长度:" + sb.toString().length());
        }
...
*/
    ...
    public static void printConvertBinary(){
        for (int i = 0;i < 128 ;i++){
            System.out.println("int 数字:" +i +" 转为二进制的表现形式为:" + BinaryUtil.convertBinary(i));
        }

    }

    public static void printConvertIntByBinary(){
        int value = BinaryUtil.convertIntByBit("1");
        System.out.println(value);

        value = BinaryUtil.convertIntByBit("1");
        System.out.println(value);

        value = BinaryUtil.convertIntByBit("10");
        System.out.println(value);

        value = BinaryUtil.convertIntByBit("11");
        System.out.println(value);

        value = BinaryUtil.convertIntByBit("100");
        System.out.println(value);

        value = BinaryUtil.convertIntByBit("101");
        System.out.println(value);
        value = BinaryUtil.convertIntByBit("110");
        System.out.println(value);
        value = BinaryUtil.convertIntByBit("111");
        System.out.println(value);

        value = BinaryUtil.convertIntByBit("1000");
        System.out.println(value);
        value = BinaryUtil.convertIntByBit("1001");
        System.out.println(value);
        value = BinaryUtil.convertIntByBit("1010");
        System.out.println(value);
        value = BinaryUtil.convertIntByBit("1011");
        System.out.println(value);
