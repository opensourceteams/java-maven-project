package com.opensourceteams.modules.common.gramar.网络编程.案例分析.n_01_简体qq聊天器.n_14_简体qq聊天器_客户端界面调整.client.network;
...
public class ClientMessageReceiverThread extends Thread {
    ...
    public void run() {
       ...
       while (true){
           ...
           if(readerMessage.isOfEnd()){
               continue;
           }else if(readerMessage.getType() == Message.DATA_TRANSFORM_TYPE_SERVER_PUSH_USERSET_CURRENT){
