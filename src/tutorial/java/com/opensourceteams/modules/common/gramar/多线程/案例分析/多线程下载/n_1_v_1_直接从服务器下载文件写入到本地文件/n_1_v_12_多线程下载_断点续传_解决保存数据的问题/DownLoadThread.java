...
public class  DownLoadThread extends Thread{
    ...
    public DownLoadThread(String url,String saveFilePath,boolean isBreakpoint,DownloadBytesBean downloadBytesBean, DownLoadUI ui,ContinueTransferringBreakpointThread continueTransferringBreakpointThread){
        this.url = url;
    ...
    public void run() {
        ...
        try {
           // raf = new RandomAccessFile(downloadBytesBean.getSaveFilePath(),"rw");
            ...
            continueTransferringBreakpointThread.removeDownloadBytesBeanVector(downloadBytesBean);
