 ...
 */
public class AlgorithmDownUtil {



    public static Vector<DownloadBytesBean>  breakpoint(String url,String saveFilePath,int n,int total,Vector<DownloadBytesBean> oldVector){
        ...
        for (int i = 0 ;i< n; i++){
            ...
            downloadBytesBean.setTotalLength(total);
            downloadBytesBean.setUrlStr(url);
