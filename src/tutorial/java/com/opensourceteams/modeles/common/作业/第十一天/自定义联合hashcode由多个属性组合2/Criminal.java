package com.opensourceteams.modeles.common.作业.第十一天.自定义联合hashcode由多个属性组合2;
...
/*
    ...
    public int hashCode() {
       ...
       // sb.append(BinaryUtil.intToBitsByByteLength(height,1));
        ...
        System.out.println("值:" +Integer.parseInt(sb.toString()));
    ...
    public String getAllPro(){
        return ""+ home +boold +height +weight  ;
    }
    @Override
